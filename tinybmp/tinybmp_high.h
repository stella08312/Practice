...
class tiny_bitmap_high : public tiny_bitmap
{
public:
	tiny_bitmap_high(std::string file_name)
...
public:
	...
	{
		double filter[3][3] = {{-1/9.0, -1/9.0, -1/9.0}, {-1/9.0, 17/9.0, -1/9.0}, {-1/9.0, -1/9.0, -1/9.0}};
